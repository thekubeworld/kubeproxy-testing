...
# kubeproxy-testing
This repo made progress and now is marked as deprecated to join the efforts with [k8s-service-lb-validator project](https://github.com/K8sbykeshed/k8s-service-lb-validator/).
