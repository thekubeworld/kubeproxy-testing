...
# kubeproxy-testing
This repo made progress and now is part of bigger movement for testing kubernetes services, see [k8s-service-lb-validator project](https://github.com/K8sbykeshed/k8s-service-lb-validator/)
